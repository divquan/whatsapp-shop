            ...
            <div>
              ...
              {cartItems.length >= 1 && cartItems.map((item) => (
                <div className="flex gap-4 sm:gap-8" key={item.id}>
                  <div>
                    <img src={item.image} className="w-[130px] h-full h-auto border object-contain" />
                  </div>
                    ...
                    <div className='flex flex-col justify-between gap-1'>
                      <div className='flex flex-col gap-[0.4px]'>
                        ...
                        <div className='flex gap-3'>
                          <span>Quantity: </span>
                          <span className="flex">
                              <span className="" onClick={() => toggleCartItemQuantity(item.id, 'dec') }>
                              ...
                              <span className="" onClick={() => toggleCartItemQuantity(item.id, 'inc') }>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        ...
                        {showEdit && (
                          <div className='shadow-lg'>
                            <div>
                              <label htmlFor={`color-${item.id}`} className=''>Change color</label>
                              <input
                              className='ring-1'
                                type="text"
                                id={`color-${item.id}`}
                            ...
                            <div>
                              <label htmlFor={`size-${item.id}`}>Change Size</label>
                              <input
                              className='ring-1'
                                type="text"
                                id={`size-${item.id}`}
                ...
                <div className="cart-bottom">
                  ...
                  <Dialog>
                    <DialogTrigger asChild>
                      <Button variant="none">
                        <span className='bg-black text-white px-4 py-2'>Place Order</span>
                      </Button>
                    </DialogTrigger>
